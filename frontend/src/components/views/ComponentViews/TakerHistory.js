...
import redBox from '../../../images/StatusRed.png'
import oval from '../../../images/Oval.png'

// 이 파트는 백엔드에서 availability 를 확인해야 하므로 백엔드 api 를 만들어서 제공해야 함.
...
export function TakerHistoryList() {
                    ...
                    >
                      <TableCell component="th" id={labelId} scope="row" padding="none">
                        {row.status === 'Available' ? (
                          ...
                          <img src={redBox} style={{ height: '14px', width: '14px' }} alt='red box'/>
                        )}
                        {row.status}
                      </TableCell>
                      <TableCell>
