...
const CENTRAL_TOKENS = [BNB, BUSD, USDT, CAKE, ETH, BTCB, USDC];

const BNB_ATTACHED_TOKENS = [
...
let CENTRAL_TOKENS_GRAPH = {};
CENTRAL_TOKENS_GRAPH[BNB] = [ETH, BTCB, USDT, BUSD, CAKE];
CENTRAL_TOKENS_GRAPH[BUSD] = [BNB, BTCB, USDT, USDC, CAKE];
CENTRAL_TOKENS_GRAPH[USDT] = [BNB, USDC, BUSD, CAKE];
CENTRAL_TOKENS_GRAPH[CAKE] = [BNB, USDT, BUSD];
CENTRAL_TOKENS_GRAPH[ETH] = [BNB, BTCB, USDC];
CENTRAL_TOKENS_GRAPH[BTCB] = [ETH, BUSD, BNB];
CENTRAL_TOKENS_GRAPH[USDC] = [ETH, USDT, BUSD];

const JSON_RPC_ENDPOINT = "https://bsc-dataseed.binance.org/";
const PANCAKE_VIEWER_CONTRACT_ADDRESS =
  "0x67a4412f1a3c64e32c85f81a8e19648d8e35e690";

const PANCAKE_SWAP_ADDRESS = "0x05ff2b0db69458a0750badebc4f9e13add608c7f";

const ORDER_BANK_VIEWER_CONTRACT_ADDRESS =
  "0x7777A83753EaE4A7b22778E2b2b9EDCD2A33d3C5";
const ORDER_BANK_V2_VIEWER_CONTRACT_ADDRESS =
...
const ALICE_DECIMAL = 6;

const tokenToBinanceSymbol = {
...
module.exports = {
  ...
  ORDER_BANK_V2_VIEWER_CONTRACT_ADDRESS,
