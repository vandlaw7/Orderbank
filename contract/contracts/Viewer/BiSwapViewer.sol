...
import "../Protocol/Biswap/IBiswapFactory.sol";
import "../Protocol/Biswap/IBiswapPair.sol";
...
contract BiswapViewer {
    IBiswapFactory public factory = IBiswapFactory(0x858E3312ed3A876947EA49d572A7C42DE08af7EE);
    ...
    function poolInfos(
        ...
        total = IBiswapFactory(factory).allPairsLength();
        ...
        for(uint256 i=0; i<count; i++) {
            ...
            IBiswapPair pair = IBiswapPair(pool);
